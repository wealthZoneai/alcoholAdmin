...
export function getTransactionsHistory(type: string) {
  return server.get(`${endpoints.getTransactionsHistory}?type=${type}`, { requiresAuth: true });
}

export function getTransactionsHistoryByType(type: string) {
